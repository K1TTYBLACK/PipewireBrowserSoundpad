...
## How it Works
* Settings are accessible at http://localhost:9876 or via icon in system tray.
* If you dont see your browser in the list, play any audio in it and it should show up.
...
[**📥 DOWNLOAD FROM RELEASES**](https://github.com/K1TTYBLACK/PipewireBrowserSoundpad/releases)
